...
def loadCases():
    ...
    rowKeys = {
        ...
        "H": {"interval": 3, "start": "2026-06-12", "lastAdded": "2026-06-05"},
        "I": {"interval": 5, "start": "2026-06-12", "lastAdded": "2026-06-05"},
        "J": {"interval": 7, "start": "2026-06-12", "lastAdded": "2026-06-05"},
    }
    cases = []
            ...
            cases.append(
                (
                    date,
                    {
                        ...
                        "interval": interval,
                        "time": "21:00",
                        "date": rowKeys[key]["start"],
                    },
                    rowKeys[key]["lastAdded"],
                    row[key],
                )
            )
            if row[key]:
